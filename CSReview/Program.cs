...
// just watched, easy
//
// in for read only param, can't modify
//
// int second = 10; //needs a memory reference, if empty, no ref
...
//
//
// out will need to assign in the method, or will get error
// int second; //needs a memory reference, if empty, no ref
// MethodByRef(out second);
// static void MethodByRef (out int first)
// {
//     first = 20;
// }
//
// can pass array parameters with params keyword

/////////////////////////////////////////////////////////////
/////enum///////

//enum Directions // think of it like an 'insect class', put below namespace for now
//{
//    East = 1,
//    West,
//    North,
...
//int northValue = (int)Directions.North;
//Console.WriteLine($"the value is {northValue}");


//Directions parsedDirection;
//Enum.TryParse("West", out parsedDirection);
//int westValue = (int)parsedDirection;
//Console.WriteLine($" West is { westValue}");
